      ...
      <div class="movie-info-detail clearfix">
        <div class="main-content">
          <div class="crumbs-nav-container">
            <a href="/welcome">南国影院</a> &gt; <a href="/movie">电影</a> &gt; {{movieInfo.movieName}}
          </div>
...
export default {
  ...
  methods: {
    async getMovieInfo(){
      ...
      //演员表
      this.movieInfo.movieActors = res.data.movieActors;
      console.log(this.movieInfo.movieActors);
